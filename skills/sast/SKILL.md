...
- Order perspectives by **priority** (Critical-leaning / high-frequency first) — this ensures the safety valve (`capPerspectives` in `workflow-template.js`) that prunes by priority on scale overflow works correctly.
